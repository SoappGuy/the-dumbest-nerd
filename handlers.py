...
async def summarise(event):
    ...
    # промпт для джипіті
    prompt = f'''Надай список тем які обговорювались у цих повідомленнях, але не більше 10. Не розповідай про подібні теми, згрупуй їх в одну. Відповідай українською: \n'''
